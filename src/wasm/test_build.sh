...
emcc -O3 -flto \
    ...
    -sEXPORTED_FUNCTIONS="['_mz_wasm_init','_mz_wasm_reset','_mz_wasm_run_frame','_mz_wasm_get_framebuffer','_mz_wasm_get_screen_width','_mz_wasm_get_screen_height','_mz_wasm_get_audio_samples','_mz_wasm_key_event','_mz_wasm_load_mzf','_malloc','_free']" \
